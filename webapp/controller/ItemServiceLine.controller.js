...
sap.ca.scfld.md.controller.BaseDetailController.extend("cross.fnd.fiori.inbox.ZCA_FIORI_INBOX.controller.ItemServiceLine", {
	...
	setLocalHeaderFooterOptions: function() {
		...
		if (this._bIsHeaderBasedApproval === true) {
			var sView = this.oRouter.getView("cross.fnd.fiori.inbox.ZCA_FIORI_INBOX.view.ItemDetails");
